...
namespace NuovoPortaleGeo.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            CohesionSSO cohesionSSO = new CohesionSSO(System.Web.HttpContext.Current.Request, System.Web.HttpContext.Current.Response, System.Web.HttpContext.Current.Session);
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var authCohesionResult = await CohesionAuthenticationHelper.AuthenticateCohesionUser(System.Web.HttpContext.Current.Session, SignInManager);

            if (authCohesionResult)
            {
                return RedirectToLocal(returnUrl);
            }
